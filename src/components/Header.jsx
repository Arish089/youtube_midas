...
const {loading, mobileMenu, setMenu} = useContext(Context);
...
const pageName = pathname?.split("/")?.filter(Boolean)?.[0]
  return (
    <div className= "sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-[#0f0f0f] dark:bg-black ">
      {loading && <Loader />}
      ...
      {pageName !== "video" && (
        ...
        <Link to="/" className ="flex h-5 justify-center items-center" >
